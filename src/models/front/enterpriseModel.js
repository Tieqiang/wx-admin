import { queryEnterpriseList, queryEnterpriseListById } from '@/services/front/enterpriseService';

const Modal = {
  namespace: 'frontEnterprise',
  state: {
    data: {
      recordList: [],
      groupCountList: [],
  ...
  effects: {
    ...
    *getListDataById({ payload, callback }, { call, put }) {
      const response = yield call(queryEnterpriseListById, payload);
