...
export function _onCreate() {
  ...
  app.model({ namespace: 'FollowEventModel', ...(require('/home/zhaotq/WebstormProjects/wx-admin/src/models/follow/event/FollowEventModel.js').default) });
...
app.model({ namespace: 'patAdmit', ...(require('/home/zhaotq/WebstormProjects/wx-admin/src/models/pat/patAdmit.js').default) });
